...
For the first few weeks, we will be using an interactive textbook called [Eloquent Javascript](www.eloquentjavasccript.net). Before you begin reading, please quickly read over the [Notes](./#notes) below.
